#ifndef CPE_DR_DATAJSON_TEST_PARSETREETEST_H
#define CPE_DR_DATAJSON_TEST_PARSETREETEST_H
#include <string.h>
...
typedef LOKI_TYPELIST_1(
    utils::testenv::with_em) ParseTreeTestBase;

class ParseTreeTest : public testenv::fixture<ParseTreeTestBase> {
public:
    ParseTreeTest();
    virtual void SetUp();
...
#define ASSERT_JSON_TREE_READ_RESULT(__expect)  do {            \
