...
TEST_F(ParseTreeTest, type_union_no_select_use_large) {
    installMeta(
...
TEST_F(ParseTreeTest, type_union_no_select_use_small) {
    installMeta(
        "<metalib tagsetversion='1' name='net'  version='1'>"
        "    <union name='S' version='1'>"
        "	     <entry name='a1' type='int16'/>"
...
TEST_F(ParseTreeTest, type_union_no_select_multi_entry) {
    installMeta(
        "<metalib tagsetversion='1' name='net'  version='1'>"
        "    <union name='S' version='1'>"
        "	     <entry name='a1' type='int16'/>"
...
TEST_F(ParseTreeTest, type_union_root) {
    installMeta(
        "<metalib tagsetversion='1' name='net'  version='1'>"
        "    <union name='S' version='1'>"
        "	     <entry name='a1' type='int16'/>"
...
TEST_F(ParseTreeTest, type_union_selector_basic) {
    installMeta(
        "<metalib tagsetversion='1' name='net'  version='1'>"
...
TEST_F(ParseTreeTest, type_union_selector_in_sub) {
    installMeta(
        "<metalib tagsetversion='1' name='net'  version='1'>"
...
TEST_F(ParseTreeTest, type_union_array_in_union) {
    installMeta(
        "<metalib tagsetversion='1' name='net'  version='1'>"
