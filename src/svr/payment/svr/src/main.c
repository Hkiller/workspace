...
int main(int argc, char * argv[]) {
    ...
    struct arg_str * run_notify_to = arg_str0(NULL, "notify-to", NULL, "payment deliver location");
    struct arg_str * run_log_dir = arg_str0(NULL, "log-dir", NULL,    "log path");
    struct arg_end * run_end = arg_end(20);
    void* run_argtable[] = { run, run_pidfile, run_root, run_app_id, run_db, run_db_ns, run_db_buf_size, run_notify_to, run_log_dir, run_end };
    int run_nerrors;
