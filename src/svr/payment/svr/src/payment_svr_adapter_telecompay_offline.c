...
int payment_svr_telecompay_offline_init(payment_svr_adapter_t adapter, cfg_t cfg) {
    return 0;
}

void payment_svr_telecompay_offline_fini(payment_svr_adapter_t adapter) {
}

int payment_svr_telecompay_offline_charge_send(
    ...
    PAYMENT_RECHARGE_RECORD * record, SVR_PAYMENT_REQ_RECHARGE_COMMIT const * req)
{
    ...
    struct payment_svr_adapter_telecompay_offline * telecompay_offline = (struct payment_svr_adapter_telecompay_offline *)adapter->m_private;
...
int payment_svr_telecompay_offline_charge_recv(
