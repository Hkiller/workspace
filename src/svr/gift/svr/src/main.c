...
int main(int argc, char * argv[]) {
    ...
    struct arg_int *  record_count = arg_int1(NULL, "generate-record-count", NULL, "max generate record count");
    ...
    void* run_argtable[] = { run, run_pidfile, run_root, run_app_id, run_db, run_db_ns, run_db_buf_size, record_count, bucket_ratio, run_log_dir, run_end };
    int run_nerrors;
