...
int main(int argc, char * argv[]) {
    ...
    struct arg_str *  run_listen = arg_str1(NULL, "listen", NULL,    "listen");
    struct arg_str * run_db = arg_str1(NULL, "db-svr", NULL, "db-connection (ip:port)");
    ...
    void* run_argtable[] = { run, run_pidfile, run_root, run_app_id, run_listen, run_db, run_db_ns, run_db_buf_size, run_log_dir, run_end };
    int run_nerrors;
