...
int main(int argc, char * argv[]) {
    ...
    struct arg_str *  run_svr_type = arg_str0(NULL, "svr-type", NULL, "set type");
    ...
    void* run_argtable[] = { run, run_svr_type, run_pidfile, run_root, run_app_id, shm, reset, record_count, bucket_ratio, run_db, run_db_ns, run_db_buf_size, run_log_dir, run_end };
    int run_nerrors;
