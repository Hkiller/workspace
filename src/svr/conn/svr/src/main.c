...
int main(int argc, char * argv[]) {
    ...
    struct arg_str *  run_max_pkg_size = arg_str0(NULL, "max-pkg-size", NULL,    "max pkg size");
    ...
    void* run_argtable[] = { run, run_pidfile, run_root, run_appid, run_port, run_conn_timeout,
                             run_ringbuf_size, run_max_pkg_size, run_svr_type, run_log_dir, run_end };
    int run_nerrors;
