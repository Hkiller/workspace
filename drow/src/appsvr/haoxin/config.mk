product:=appsvr_haoxin
$(product).type:=lib cpe-dr
$(product).depends:=gd_timer gd_app_attr appsvr_payment appsvr_sdk
...
$(product).cpe-dr.data.source:=$(addprefix $(product-base)/../../../pro/appsvr_haoxin/,\
                                   $(shell cat $(product-base)/protocol.def))
$(product).cpe-dr.data.h.output:=inc/protocol/appsvr/haoxin
$(product).cpe-dr.data.h.with-traits:=traits_appsvr_haoxin.cpp
$(product).cpe-dr.data.c.output:=metalib_appsvr_haoxin.c
$(product).cpe-dr.data.c.arg-name:=g_metalib_appsvr_haoxin
