...
$(product).android.native-libs:=$(product-base)/android/libs/libme_unipay.so $(product-base)/android/libs/libmegjb.so $(product-base)/android/libs/libsmsprotocol.so
