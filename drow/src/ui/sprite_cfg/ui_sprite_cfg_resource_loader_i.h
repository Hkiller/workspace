#ifndef UI_SPRITE_CFG_RESOURCE_LOADER_I_H
#define UI_SPRITE_CFG_RESOURCE_LOADER_I_H
...
struct ui_sprite_cfg_resource_loader {
    ui_sprite_cfg_loader_t m_loader;
    const char * m_name;
    void * m_ctx;
    ui_sprite_cfg_load_resource_fun_t m_fun;
...
ui_sprite_cfg_resource_loader_create(
    ...
    const char * name,
    void * ctx,
    ui_sprite_cfg_load_resource_fun_t fun);
