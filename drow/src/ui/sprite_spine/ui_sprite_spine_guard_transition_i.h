#ifndef UI_SPRITE_SPINE_GUARD_TRANSITION_I_H
#define UI_SPRITE_SPINE_GUARD_TRANSITION_I_H
#include "render/utils/ui_percent_decorator.h"
#include "plugin/spine/plugin_spine_obj.h"
#include "ui/sprite_spine/ui_sprite_spine_guard_transition.h"
...
struct ui_sprite_spine_guard_transition {
    ui_sprite_spine_module_t m_module;
    char * m_cfg_part;
    char * m_cfg_enter_transition;
    char * m_cfg_leave_transition;
    char * m_part;
};
