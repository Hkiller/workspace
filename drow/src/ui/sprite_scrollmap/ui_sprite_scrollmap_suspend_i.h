#ifndef UI_SPRITE_SCROLLMAP_SUSPEND_I_H
#define UI_SPRITE_SCROLLMAP_SUSPEND_I_H
#include "ui/sprite_scrollmap/ui_sprite_scrollmap_suspend.h"
...
struct ui_sprite_scrollmap_suspend {
