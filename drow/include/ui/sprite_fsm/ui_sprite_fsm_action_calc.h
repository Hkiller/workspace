#ifndef UI_SPRITE_FSM_ACTION_CALC_H
#define UI_SPRITE_FSM_ACTION_CALC_H
...
int ui_sprite_fsm_action_check_calc_bool(uint8_t * result, const char * def, ui_sprite_fsm_action_t fsm_action, dr_data_source_t data_source, error_monitor_t em);
int ui_sprite_fsm_action_check_calc_int8(int8_t * result, const char * def, ui_sprite_fsm_action_t fsm_action, dr_data_source_t data_source, error_monitor_t em);
int ui_sprite_fsm_action_check_calc_uint8(uint8_t * result, const char * def, ui_sprite_fsm_action_t fsm_action, dr_data_source_t data_source, error_monitor_t em);
int ui_sprite_fsm_action_check_calc_int16(int16_t * result, const char * def, ui_sprite_fsm_action_t fsm_action, dr_data_source_t data_source, error_monitor_t em);
int ui_sprite_fsm_action_check_calc_uint16(uint16_t * result, const char * def, ui_sprite_fsm_action_t fsm_action, dr_data_source_t data_source, error_monitor_t em);
int ui_sprite_fsm_action_check_calc_int32(int32_t * result, const char * def, ui_sprite_fsm_action_t fsm_action, dr_data_source_t data_source, error_monitor_t em);
int ui_sprite_fsm_action_check_calc_uint32(uint32_t * result, const char * def, ui_sprite_fsm_action_t fsm_action, dr_data_source_t data_source, error_monitor_t em);
int ui_sprite_fsm_action_check_calc_int64(int64_t * result, const char * def, ui_sprite_fsm_action_t fsm_action, dr_data_source_t data_source, error_monitor_t em);
int ui_sprite_fsm_action_check_calc_uint64(uint64_t * result, const char * def, ui_sprite_fsm_action_t fsm_action, dr_data_source_t data_source, error_monitor_t em);
int ui_sprite_fsm_action_check_calc_float(float * result, const char * def, ui_sprite_fsm_action_t fsm_action, dr_data_source_t data_source, error_monitor_t em);
int ui_sprite_fsm_action_check_calc_double(double * result, const char * def, ui_sprite_fsm_action_t fsm_action, dr_data_source_t data_source, error_monitor_t em);    
