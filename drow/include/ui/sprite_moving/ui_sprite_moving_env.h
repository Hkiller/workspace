#ifndef UI_SPRITE_MOVING_ENV_H
#define UI_SPRITE_MOVING_ENV_H
...
extern const char * UI_SPRITE_MOVING_ENV_NAME;

ui_sprite_moving_env_t ui_sprite_moving_env_create(ui_sprite_moving_module_t module, ui_sprite_world_t world);
