#ifndef DROW_PLUGIN_UI_PAGE_CALC_H
#define DROW_PLUGIN_UI_PAGE_CALC_H
...
int plugin_ui_page_try_calc_int32(int32_t * result, const char * def, plugin_ui_page_t page, dr_data_source_t daityta_source, error_monitor_t em);
...
int plugin_ui_page_check_calc_bool(uint8_t * result, const char * def, plugin_ui_page_t page, dr_data_source_t data_source, error_monitor_t em);
int plugin_ui_page_check_calc_int8(int8_t * result, const char * def, plugin_ui_page_t page, dr_data_source_t data_source, error_monitor_t em);
int plugin_ui_page_check_calc_uint8(uint8_t * result, const char * def, plugin_ui_page_t page, dr_data_source_t data_source, error_monitor_t em);
int plugin_ui_page_check_calc_int16(int16_t * result, const char * def, plugin_ui_page_t page, dr_data_source_t data_source, error_monitor_t em);
int plugin_ui_page_check_calc_uint16(uint16_t * result, const char * def, plugin_ui_page_t page, dr_data_source_t data_source, error_monitor_t em);
int plugin_ui_page_check_calc_int32(int32_t * result, const char * def, plugin_ui_page_t page, dr_data_source_t data_source, error_monitor_t em);
int plugin_ui_page_check_calc_uint32(uint32_t * result, const char * def, plugin_ui_page_t page, dr_data_source_t data_source, error_monitor_t em);
int plugin_ui_page_check_calc_int64(int64_t * result, const char * def, plugin_ui_page_t page, dr_data_source_t data_source, error_monitor_t em);
int plugin_ui_page_check_calc_uint64(uint64_t * result, const char * def, plugin_ui_page_t page, dr_data_source_t data_source, error_monitor_t em);
int plugin_ui_page_check_calc_float(float * result, const char * def, plugin_ui_page_t page, dr_data_source_t data_source, error_monitor_t em);
int plugin_ui_page_check_calc_double(double * result, const char * def, plugin_ui_page_t page, dr_data_source_t data_source, error_monitor_t em);
const char * plugin_ui_page_check_calc_str(
    mem_buffer_t buffer, const char * def, plugin_ui_page_t page, dr_data_source_t data_source, error_monitor_t em);
