...
#line 1 "/data/lokiwang/workspace/study/cpe/3rdTools/log4c/src/sd/domnode-xml-parser.y"
...
{
       0,     0,     3,     7,    10,    11,    13,    14,    19,    22,
      28,    31,    34,    37,    38,    40,    43,    44,    46
};

/* YYRHS -- A `-1'-separated list of the rules' RHS. */
static const yysigned_char yyrhs[] =
{
      14,     0,    -1,    15,    17,    15,    -1,    15,    16,    -1,
      -1,    11,    -1,    -1,    12,    18,    22,    19,    -1,     5,
       6,    -1,     6,    20,     7,    21,     6,    -1,    20,    10,
      -1,    20,    17,    -1,    20,    16,    -1,    -1,     8,    -1,
      22,    23,    -1,    -1,     8,    -1,     8,     4,     9,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const unsigned char yyrline[] =
{
       0,    61,    61,    65,    66,    70,    85,    84,   118,   126,
     146,   156,   157,   158,   162,   169,   170,   174,   180
};
#endif
...
{
  "$end", "error", "$undefined", "ENDDEF", "EQ", "SLASH", "CLOSE", "END",
  "NAME", "VALUE", "DATA", "COMMENT", "START", "$accept", "document",
  "misc", "comment", "element", "@1", "empty_or_content", "content",
  "name", "attribute_seq_opt", "attribute", 0
};
#endif
...
{
       4,     0,     0,     1,     5,     6,     3,     4,    16,     2,
       0,     0,    13,    17,     7,    15,     8,     0,     0,     0,
      10,    12,    11,    18,    14,     0,     9
};
...
{
     -11,     8,   -10,   -11,   -11,   -11,   -11,   -11,   -11,    -1,
       1,     5,   -11,     9,   -11,   -11,   -11,    -7,     3,     6,
...
{
      19,     4,     5,    20,     4,     5,    11,    12,     3,    13,
       4,    16,    23,    18,    24,    21,    26,    22,     9
};

static const unsigned char yycheck[] =
{
       7,    11,    12,    10,    11,    12,     5,     6,     0,     8,
      11,     6,     9,     4,     8,    17,     6,    17,     7
};
...
{
       0,    14,    15,     0,    11,    12,    16,    17,    18,    15,
      22,     5,     6,     8,    19,    23,     6,    20,     4,     7,
      10,    16,    17,     9,     8,    21,     6
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 5:
#line 71 "/data/lokiwang/workspace/study/cpe/3rdTools/log4c/src/sd/domnode-xml-parser.y"
    {
  ...
  case 6:
#line 85 "/data/lokiwang/workspace/study/cpe/3rdTools/log4c/src/sd/domnode-xml-parser.y"
    {
  ...
  case 8:
#line 119 "/data/lokiwang/workspace/study/cpe/3rdTools/log4c/src/sd/domnode-xml-parser.y"
    {
    sd_domnode_t* node = sd_stack_peek(a_maker->elements);
    assert(node != 0);
  ...
  case 9:
#line 127 "/data/lokiwang/workspace/study/cpe/3rdTools/log4c/src/sd/domnode-xml-parser.y"
    {
    sd_domnode_t* node = sd_stack_peek(a_maker->elements);
    assert(node != 0);
  ...
  case 10:
#line 147 "/data/lokiwang/workspace/study/cpe/3rdTools/log4c/src/sd/domnode-xml-parser.y"
    {
    sd_domnode_t* node = sd_stack_peek(a_maker->elements);
    assert(node != 0);
  ...
  case 14:
#line 163 "/data/lokiwang/workspace/study/cpe/3rdTools/log4c/src/sd/domnode-xml-parser.y"
    {
    (yyval.s) = (yyvsp[0].s);
}
    break;
  ...
  case 17:
#line 175 "/data/lokiwang/workspace/study/cpe/3rdTools/log4c/src/sd/domnode-xml-parser.y"
    {
  ...
  case 18:
#line 181 "/data/lokiwang/workspace/study/cpe/3rdTools/log4c/src/sd/domnode-xml-parser.y"
    {
...
/* Line 1126 of yacc.c.  */
#line 1288 "domnode-xml-parser.c"

  yyvsp -= yylen;
  yyssp -= yylen;
...
#line 190 "/data/lokiwang/workspace/study/cpe/3rdTools/log4c/src/sd/domnode-xml-parser.y"
