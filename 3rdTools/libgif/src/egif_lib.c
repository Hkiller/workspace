...
EGifOpen(void *userData, OutputFunc writeFunc, int *Error)
{
    ...
    Private->gif89 = GIF_FALSE;	/* initially, write GIF87 */
...
/******************************************************************************
 ...
 GIF87 value is 0 (numerically the same as GifBool GIF_FALSE) and the GIF89 value
 is 1 (numerically the same as GifBool GIF_TRUE).  That way we'll even preserve
...
unsigned int EGifGCBToExtension(const GraphicsControlBlock *GCB,
